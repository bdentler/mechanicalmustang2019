...
public class RobotMap {
  ...
  public static final int CANDY_CANE_DRIVE_WHEEL_PWM = 5;
  ...
  public static final int CANDY_CANE_DRIVE_DIO = 6;
  ...
  public static final double LIFT_ARM_UP_SPEED = .7;
  public static final double CANDY_CANE_DOWN_SPEED = -1.0;
  public static final double CANDY_CANE_UP_SPEED = 0.7;
  public static final double LIFT_DRIVE_WHEEL_ON_SPEED = 0.6;
  public static final double LIFT_DRIVE_WHEEL_OFF_SPEED = -0.6;
  public static final double CANDY_CANE_DRIVE_ON_SPEED = 0.6;
  ...
  // Motor Counters
    //climb down
  public static final int LIFTARM_DOWN_COUNT = 320;
  public static final int LIFTARM_UP_COUNT = 320;
  public static final int CANDYCANES_DOWN_COUNT = 380;
  public static final int CANDYCANES_UP_COUNT = 380;
  public static final int LIFT_DRIVE_OFF_COUNT = 80;
  public static final int CANDY_CANE_DRIVE_OFF_COUNT = 80;

    //climb up level 2
  public static final int LIFTARM_DOWN_COUNT2 = 320;
  public static final int LIFTARM_UP_COUNT2 = 320;
  public static final int CANDYCANES_DOWN_COUNT2 = 380;
  public static final int CANDYCANES_UP_COUNT2 = 380;
  public static final int LIFT_DRIVE_ON_COUNT2 = 400;
  public static final int CANDY_CANE_DRIVE_ON_COUNT2 = 400;

    //climb up level 3
  public static final int LIFTARM_DOWN_COUNT3 = 320;
  public static final int LIFTARM_UP_COUNT3 = 320;
  public static final int CANDYCANES_DOWN_COUNT3 = 380;
  ...
  public static final int WRIST_DEPLOY_COUNT = 140;
