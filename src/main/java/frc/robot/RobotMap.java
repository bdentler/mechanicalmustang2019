...
public class RobotMap {
  ...
  public static final double LIFT_ARM_UP_SPEED = 0.8;
  public static final double CANDY_CANE_DOWN_SPEED = -1.0;
  public static final double CANDY_CANE_UP_SPEED = 0.8;
  public static final double LIFT_DRIVE_WHEEL_ON_SPEED = -0.9;
  public static final double LIFT_DRIVE_WHEEL_OFF_SPEED = 0.9;
  public static final double CANDY_CANE_DRIVE_ON_SPEED = 0.9;
  public static final double CANDY_CANE_DRIVE_OFF_SPEED = -0.9;
  ...
  public static final double WRIST_MOTOR_DOWN_SPEED = -0.7;
  public static final double VACUUM_MAX_SPEED = 1.0;
  public static final double VACUUM_RAMP = 0.04;

  // Motor Counters
    //climb down
  public static final int LIFTARM_DOWN_COUNT = 280;
  public static final int LIFTARM_UP_COUNT = 320;
  public static final int CANDYCANES_DOWN_COUNT = 290;
  public static final int CANDYCANES_UP_COUNT = 290;
  public static final int LIFT_DRIVE_OFF_COUNT = 100;
  public static final int CANDY_CANE_DRIVE_OFF_COUNT = 100;

    //climb up level 2
  public static final int LIFTARM_DOWN_COUNT2 = 350;
  public static final int LIFTARM_UP_COUNT2 = 350;
  public static final int CANDYCANES_DOWN_COUNT2 = 335;
  public static final int CANDYCANES_UP_COUNT2 = 335;
  ...
  public static final int CANDYCANES_DOWN_COUNT3 = 195;
  public static final int CANDYCANES_UP_COUNT3 = 390;
  ...
  public static final int BOOM_ARM_DEPLOY_COUNT = 420;
  public static final int WRIST_DEPLOY_COUNT = 180;
  ...
  public static final double DRIVE_OFF_HABITAT_TIME = 4;    //Turn on main drive wheels for this number of seconds
